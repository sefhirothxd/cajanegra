		...
		<Layout>
			<Header>
				<div className="min-h-screen bg-white flex  justify-center items-center flex-col leading-none">
					...
					></img>
					<h1 className="text-dark-100 font-black text-6xl sm:text-4xl z-10 xs:text-2xl md:text-4xl sm:text-center">
						HAS QUE TE RECUERDEN.
					</h1>
					<p className="font-medium text-lg sm:text-center z-10 xs:text-base">
						Pero bien.
					</p>
				</div>
			</Header>
