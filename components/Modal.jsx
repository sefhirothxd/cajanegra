...
const Modal = () => {
	return (
		<div className="fixed left-0 top-0 w-full h-full bg-modalFondo z-20 flex flex-col justify-between  transition-all ease-in-out scale-95  duration-500">
			...
			<div className="flex items-end text-6xl sm:text-3xl sm:text-center sm:justify-center sm:h-full sm:items-center  w-full justify-start">
				<Bcolores className="w-16 sm:hidden" />
			...
			<div className="flex justify-between sm:justify-center">
				<ul className="flex sm:hidden justify-between xl:text-xs lg:flex-col lg:ml-16 lg:text-base lg:items-start items-center text-light-200 mb-14 lg:mb-0 ml-28 w-11/12">
					<li className="font-Roboto italic leading-5 lg:mb-3">
				...
				<div className="hidden sm:flex sm:absolute bottom-0 sm:justify-center  w-11/12">
